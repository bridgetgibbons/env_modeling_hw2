...
sens_yield_sobol_short = sensitivity::tell(sens_yield_sobol_short, sobol_result, sobol_result.names="mean_value")
...
s_short_result <- matrix((unlist(sens_yield_sobol_short)), ncol = 1, byrow = TRUE)
