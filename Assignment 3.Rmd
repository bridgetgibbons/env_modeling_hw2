...
## From the printed results below, we can see that the rank of the parameters (from largest to smallest) are:
...
# what is our value and key ??

LHS_results = LHS_results %>% pivot_longer(value="mean_value", key="yield")
ggplot(LHS_results, aes(yield, mean_value, col=yield))+geom_boxplot()+labs(y="Yield (as anomoly)")

ggplot(LHS_results, aes(yield, mean_value, col=yield))+geom_boxplot()+labs(y="Yield (as anomoly)")+facet_wrap(~yield, scales="free")
...
# print the df only, or rank and graph??
