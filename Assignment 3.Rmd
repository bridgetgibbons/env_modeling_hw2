...
X1 = cbind.data.frame(sobol_x1, sobol_x2, sobol_x3, sobol_x4)
...
X2 = cbind.data.frame(sobol_x1, sobol_x2, sobol_x3, sobol_x4)

sens_yield_sobol = sobol2007(model = NULL, X1, X2, nboot = 100)

# run model for the parameter sets

sobol_result = mapply(FUN = yield_function_assignment3, x1 = sens_yield_sobol$X$sobol_x1, x2 = sens_yield_sobol$X$sobol_x2, x3 = sens_yield_sobol$X$sobol_x3, x4 = sens_yield_sobol$X$sobol_x4, MoreArgs = list(climate = clim))

sens_yield_sobol = sensitivity::tell(sens_yield_sobol, sobol_result, sobol_result.names="ga")
...
print(sens_yield_sobol)
plot(sens_yield_sobol)
...
# Now we can compare the LHS and Sobel graphs
