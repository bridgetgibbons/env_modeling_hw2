...
sob <- ggplot(data = s_short_result_df, aes(x = " ", y = mean_value)) +
    geom_boxplot() +
    labs( 
...
# boxplots
ggplot(LHS_results, aes(yield, mean_value, col=yield)) + geom_boxplot() + geom_boxplot(aes(sob)) + labs(y="Yield (as Anomaly)")
