...
sobol_result = mapply(FUN = yield_function_assignment3, x1 = sens_yield_sobol_short$X$sobol_x1, x2 = sens_yield_sobol_short$X$sobol_x2, x3 = sens_yield_sobol_short$X$sobol_x3, x4 = sens_yield_sobol_short$X$sobol_x4, intercept = sens_yield_sobol_short$X$sobol_int, MoreArgs = list(climate = clim))

sens_yield_sobol_short = sensitivity::tell(sens_yield_sobol_short, sobol_result, sobol_result.names="ga")
...
sens_yield_sobol_short$S

sens_yield_sobol_short$T

print(sens_yield_sobol_short)
plot(sens_yield_sobol_short)
...
sobol_result = mapply(FUN = yield_function_assignment3, x1 = sens_yield_sobol_long$X$sobol_x1, x2 = sens_yield_sobol_long$X$sobol_x2, x3 = sens_yield_sobol_long$X$sobol_x3, x4 = sens_yield_sobol_long$X$sobol_x4, intercept = sens_yield_sobol_long$X$sobol_int, MoreArgs = list(climate = clim))

sens_yield_sobol_long = sensitivity::tell(sens_yield_sobol_long, sobol_result, sobol_result.names="ga")
