...
ggplot(s_short_result_df, aes(mean_value)) +
  ...
  labs(title = "Cumulative Distribution Sobel-Short Method") +
  theme_classic()
...
ggplot(s_long_result_df, aes(mean_value)) +
  stat_ecdf(geom = "step") +
  xlab("Mean Yield Anomaly (ton/acre)") +
  labs(title = "Cumulative Distribution Sobel-Long Method") +
  theme_classic()
